...
const probe = [
  ...
  "if (tables !== 47 || views !== 2 || userVersion !== 2) { console.error(`SQLite schema contract mismatch: ${tables} tables, ${views} views, user_version ${userVersion}.`); process.exit(2) }",
...
console.log('Electron SQLite check passed: native ABI, 47 common tables, 2 views, user_version 2, foreign keys and integrity.')
